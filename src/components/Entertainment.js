...
const Entertainment = () => {
	const test = [
		{
			image:
				"https://www.naijaloaded.com.ng/wp-content/uploads/2021/03/burna-2-copy.jpg",
		...
		{
			image:
				"https://static.billboard.com/files/2020/04/Davido-press_courtesy-of-Davido-Billboard-1548-1587682585-1024x677.jpg",
			title: "Burna song in biden innuguration",
			text:
				"Fayose Bewitched, Enslaved Ekiti People For Four Years – Omotunde ",
		},
	...
	return (
		<section id="entertainment" className="newssport">
			...
			<div className="pofnewssport">
				...
				<div className="advert three"></div>
			</div>
		</section>
	);
};
